...
public class ThunderousFortunesKYEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(ThunderousFortunesKYEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/ThunderousFortunesKYIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/ThunderousFortunesKYIW/InitOutcome.xml").getDocumentElement();
